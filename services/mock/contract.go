...
import (
	...
	services "github.com/labbsr0x/githunter-data-feed/services"
	reflect "reflect"
)
...
func (m *MockContract) GetCommitsRepo(arg0, arg1, arg2, arg3, arg4 string) (*services.CommitsResponseContract, error) {
	m.ctrl.T.Helper()
